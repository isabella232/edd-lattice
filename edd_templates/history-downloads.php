...
if ( $purchases ) :
	...
	<table id="edd_user_history" class="table-fancy">
		<thead>
			<tr class="edd_download_history_row">
				...
				<th class="edd_download_download_name"><?php _e( 'Download Name', 'lattice' ); ?></th>
				<?php if ( ! edd_no_redownload() ) : ?>
					<th class="edd_download_download_files"><?php _e( 'Files', 'lattice' ); ?></th>
							...
							<td class="edd_download_download_files">
								...
								if ( edd_is_payment_complete( $payment->ID ) ) :
									...
									if ( $download_files ) :
										...
										_e( 'No downloadable files found.', 'lattice' );
									endif; // End if payment complete

								else : ?>
									<span class="edd_download_payment_status">
										<?php printf( __( 'Payment status is %s', 'lattice' ), edd_get_payment_status( $payment, true) ); ?>
									</span>
									<?php
	...
	<p class="edd-no-downloads"><?php _e( 'You have not purchased any downloads', 'lattice' ); ?></p>
	<?php
endif;
